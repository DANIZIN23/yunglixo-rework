...
class Paths
{
	...
	inline static public function voicesReshaped(song:String):Any
	{
		var songKey:String = '${CoolUtil.swapSpaceDash(song.toLowerCase())}/VoicesR';
		var voicesReshaped = returnSound('songs', songKey);
		return voicesReshaped;
	}

	inline static public function instReshaped(song:String):Any
	{
		var songKey:String = '${CoolUtil.swapSpaceDash(song.toLowerCase())}/InstR';
		var instReshaped = returnSound('songs', songKey);
		return instReshaped;
	}
